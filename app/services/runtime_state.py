...
class RuntimeStateService:
    def get_agent_mode(self) -> str:
        mode = self._get_value("agent_mode", settings.default_agent_mode)
    ...
    def set_agent_mode(self, mode: str) -> str:
        ...
        self._set_value("agent_mode", normalized)
        return normalized

    def get_display_currency(self) -> str:
        currency = self._get_value("display_currency", settings.display_currency).upper()
    ...
    def get_active_profile(self) -> dict[str, object]:
        ...
        try:
            ...
            profile = apply_overrides_to_profile(profile)
        except Exception:
            pass
