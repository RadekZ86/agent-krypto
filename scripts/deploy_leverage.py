"""Deploy leverage learning system files to production server."""
import paramiko
import time
...
FILES = [
    ...
    ("app/services/leverage_engine.py", "app/services/leverage_engine.py"),
    ("app/services/bybit_market.py", "app/services/bybit_market.py"),
    ("app/services/bybit_api.py", "app/services/bybit_api.py"),
    ("app/services/learning_center.py", "app/services/learning_center.py"),
    ("app/services/agent_cycle.py", "app/services/agent_cycle.py"),
